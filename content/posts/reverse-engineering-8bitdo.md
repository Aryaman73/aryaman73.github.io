...
> i also really don't like the karabiner-elements ui, and wanted to try avoid using it.
...
But the big circular accessories that plug into the keyboard's 3.5mm jack turned out to be a completely different animal from the on-board Super keys, and I couldn't leave them alone.
